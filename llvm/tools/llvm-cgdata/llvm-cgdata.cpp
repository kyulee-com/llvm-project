...
//===----------------------------------------------------------------------===//
//
// llvm-cgdata parses raw codegen data embedded in compiled object files, and
...
// by passing -fcodegen-data-use=<file.cgdata> to Clang.
//
//===----------------------------------------------------------------------===//
...
cl::SubCommand DumpSubcommand(
    "dump",
    "Takes a codegen data file and displays the codegen data. See detailed "
    "documentation in "
    "https://llvm.org/docs/CommandGuide/llvm-cgdata.html#cgdata-dump");
cl::SubCommand MergeSubcommand(
    "merge",
    "Takes object files having raw codegen data, and merge them together. "
    "See detailed documentation in "
    "https://llvm.org/docs/CommandGuide/llvm-cgdata.html#cgdata-merge");
