...
using IndexPairOpndHashMap = DenseMap<std::pair<unsigned, unsigned>, IRHash>;
struct FunctionHashInfo {
  ...
  std::unique_ptr<IndexPairOpndHashMap> IndexPairOpndHash;
  ...
  FunctionHashInfo(IRHash FuntionHash,
      ...
      : FunctionHash(FuntionHash),
        ...
        IndexPairOpndHash(std::move(IndexPairOpndHash)) {}
