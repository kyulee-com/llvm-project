...
; CHECK-ELF-LABEL:   .section  __llvm_mipmap,"aw",@progbits

; CHECK-ELF:         .p2align   3
; CHECK-ELF-LABEL: _Z3fooi$MAP:
; CHECK-ELF-NEXT:  [[FOO_REF:.*]]:
; CHECK-ELF-NEXT:    .long  __start___llvm_mipraw-[[FOO_REF]] # Raw Section Start PC Offset
; CHECK-ELF-NEXT:    .long  _Z3fooi$RAW-[[FOO_REF]]         # Raw Profile Symbol PC Offset
; CHECK-ELF-NEXT:    .long  _Z3fooi-[[FOO_REF]]             # Function PC Offset
...
; CHECK-ELF-NEXT:    .long  __start___llvm_mipraw-[[GOO_REF]] # Raw Section Start PC Offset
; CHECK-ELF-NEXT:    .long  _Z3gooi$RAW-[[GOO_REF]]         # Raw Profile Symbol PC Offset
; CHECK-ELF-NEXT:    .long  _Z3gooi-[[GOO_REF]]             # Function PC Offset
