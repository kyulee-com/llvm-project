...
void MCObjectFileInfo::initELFMCObjectFileInfo(const Triple &T, bool Large) {
  ...
  MIPRawSection = Ctx->getELFSection(MIP_RAW_SECTION_NAME, ELF::SHT_PROGBITS,
                                     ELF::SHF_WRITE | ELF::SHF_ALLOC);
  MIPMapSection = Ctx->getELFSection(MIP_MAP_SECTION_NAME, ELF::SHT_PROGBITS,
                                     ELF::SHF_WRITE);
  ...
  MIPMapHeaderComdatSection = Ctx->getELFSection(
      MIP_MAP_SECTION_NAME, ELF::SHT_PROGBITS, ELF::SHF_WRITE | ELF::SHF_GROUP,
